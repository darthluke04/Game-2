...
var dcanvasx = window.innerWidth;
var dcanvasy = window.innerHeight;
...
function draw() {
	...
	if (health3 > canvasx / 13.66) health3 = canvasx / 13.66;
	...
	if (hide == 0) {
		...
		text("Difficulty:  ", canvasx / 2, 150)
		text(difficulty, (canvasx / 2) + 50, 150)
